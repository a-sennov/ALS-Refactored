...
namespace AlsRotationModeTags
{
	...
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Driven)
}
...
namespace AlsOverlayModeTags
{
	...
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Knife)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Katana)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Lighter)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Flashlight)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Shuriken)
...
namespace AlsLocomotionActionTags
{
	...
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Interact)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Parkour)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Drop)
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Slide)
}
